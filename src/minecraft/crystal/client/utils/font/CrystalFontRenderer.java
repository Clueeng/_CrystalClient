...
public class CrystalFontRenderer extends CFont {
    ...
    public CrystalFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    public CrystalFontRenderer derive(int style, float fontSize) {
        CrystalFontRenderer newFont = this;
        newFont.setFont(font.deriveFont(style, fontSize));
        return newFont;
    }
